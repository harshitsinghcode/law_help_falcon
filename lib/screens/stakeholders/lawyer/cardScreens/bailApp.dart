...
class BailGenerationPage extends StatefulWidget {
  ...
  @override
  State<BailGenerationPage> createState() => _BailGenerationPageState();
}

class _BailGenerationPageState extends State<BailGenerationPage> {
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Text(
                  ...
                  style: regularStyle,
                  textAlign: pw.TextAlign.justify),
              pw.Text('PRAYER:', style: boldStyle),
              pw.Text(
